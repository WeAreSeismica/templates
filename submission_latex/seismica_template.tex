...
%% supplement: for supplements - no line numbers, two-column, and numbering is S1, S2, etc. Note that we do not typeset supplements.

\documentclass[languages={french,japanese,arabic}]{seismica}
...
%% REPORT, select a report type within: 
